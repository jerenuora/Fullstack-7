...
test('Blog renders title, author, not url, likes', () => {
  ...
  expect(component.container).toHaveTextContent('A title')
  expect(component.container).toHaveTextContent('An author')
  expect(component.container).not.toHaveTextContent('www.url.com')
